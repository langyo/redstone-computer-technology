...
在很久以前，信息的定义确实很模糊，因为当时并没有什么办法能衡量信息的大小。直到 1948 年，信息论创始人香农(C. E. Shannon)发表了[《A Mathematical Theory of Communication》](http://www.math.harvard.edu/~ctm/home/text/others/shannon/entropy/entropy.pdf)（《通信的数学原理》）一文，提出了“信息熵(shang)”的概念后，信息才正式地有了确切定义、可以度量，成为了后来信息学发展的重要基石。
