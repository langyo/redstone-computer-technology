...
* [什么是信息](part2.md#shen-me-shi-xin-xi)
* [字长与大端序及小端序](part2.md#zi-chang-yu-da-duan-xu-xiao-duan-xu)
* [字符编码与BCD码](part2.md#zi-fu-bian-ma-yu-bcd-ma)
* [原码及反码与补码](part2.md#yuan-ma-fan-ma-yu-bu-ma)
* [定点数与浮点数](part2.md#ding-dian-shu-yu-fu-dian-shu)

### 什么是信息

信息无处不在。我们可以说某本书或某部电影中都包含了大量的信息，但却没有办法去精确地比较哪一边信息更多。换言之，在没有出现信息论之前，大家对信息这个概念很模糊，仅能做到不断地获取、解读信息而已，但并不知道信息有量的概念。

在很久以前，信息的定义确实很模糊，因为当时并没有什么办法能衡量信息的大小。直到 1948 年，信息论创始人香农\(C. E. Shannon\)发表了[《A Mathematical Theory of Communication》](https://www.math.harvard.edu/~ctm/home/text/others/shannon/entropy/entropy.pdf)（《通信的数学原理》）一文，提出了“信息熵\(shang\)”的概念后，信息才正式地有了确切定义、可以度量，成为了后来信息学发展的重要基石。
...
| ...... | \(更多单位请参阅[维基百科中的表格](https://zh.wikipedia.org/wiki/字节)\)\(如果你不能科学上网，可以先查看未被防火墙屏蔽的[英文版本](https://en.wikipedia.org/wiki/Byte)\) |
